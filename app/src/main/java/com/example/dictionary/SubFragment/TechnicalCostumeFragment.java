...
public class TechnicalCostumeFragment  extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.technicalcostume_fragment,container,false);
        criteria = v.findViewById(R.id.criteria);
        process = v.findViewById(R.id.processItem);
        HashMap<String, List<String>> expandableListDetail = ExpandableTechnicalCostumeDataPump.getData();
