...
public class SafetyBeltFragment extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.safety_belt_fragment,container,false);
        process = v.findViewById(R.id.processItem);
        process2 = v.findViewById(R.id.processItem2);
        HashMap<String, List<String>> expandableListDetail = ExpandableSafetyBeltDataPump.getData();
